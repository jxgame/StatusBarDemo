...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = getContext().getResources().getColor(android.R.color.black);
    ...
    private int tabTextColor = getContext().getResources().getColor(android.R.color.black);
